                         ...
                         MultiloadApplet *ma)
{
    ...
    g_settings_bind (ma->settings, VIEW_CPULOAD_KEY,  GET_WIDGET ("graph_cpuload_checkbox"),  "active", G_SETTINGS_BIND_DEFAULT);
    g_settings_bind (ma->settings, VIEW_MEMLOAD_KEY,  GET_WIDGET ("graph_memload_checkbox"),  "active", G_SETTINGS_BIND_DEFAULT);
    g_settings_bind (ma->settings, VIEW_NETLOAD_KEY,  GET_WIDGET ("graph_netload2_checkbox"), "active", G_SETTINGS_BIND_DEFAULT);
    g_settings_bind (ma->settings, VIEW_SWAPLOAD_KEY, GET_WIDGET ("graph_swapload_checkbox"), "active", G_SETTINGS_BIND_DEFAULT);
    g_settings_bind (ma->settings, VIEW_LOADAVG_KEY,  GET_WIDGET ("graph_loadavg_checkbox"),  "active", G_SETTINGS_BIND_DEFAULT);
    g_settings_bind (ma->settings, VIEW_DISKLOAD_KEY, GET_WIDGET ("graph_diskload_checkbox"), "active", G_SETTINGS_BIND_DEFAULT);
    ...
    gtk_dialog_set_default_response (GTK_DIALOG (ma->prop_dialog), GTK_RESPONSE_CLOSE);
